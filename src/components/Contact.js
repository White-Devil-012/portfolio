...
import contactImg from "../assets/img/naruto-baryon.png";
import 'animate.css';
...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    emailjs.sendForm(process.env.REACT_APP_SERVICE_ID, process.env.REACT_APP_TEMPLATE_ID, form.current, {publicKey: process.env.REACT_APP_PUBLIC_KEY})
      .then((result) => {
